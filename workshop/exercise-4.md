...
Add some more project files to your repository. Commit and push the new files. Note that you can add multiple files with a single commit. You don't have to do a separate commit for each individual file.
